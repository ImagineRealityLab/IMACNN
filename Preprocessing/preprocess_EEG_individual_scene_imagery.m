...
ss=12:12;% Participants 1 and 6 were excluded 
prestim=1;
baseline=0.5;%caution! s10 does not have all sessions and the trial codes for s3 are off
poststim=5;
...
for sess_num=10:10%subj_sessions(s)% for each session
